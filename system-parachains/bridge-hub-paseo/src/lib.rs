...
pub type SignedExtra = (
	...
	bridge_to_westend_config::RefundBridgeHubWestendMessages,
);
...
construct_runtime!(
	pub enum Runtime
	{
		...
		// Westend bridge pallets.
		BridgeWestendGrandpa: pallet_bridge_grandpa::<Instance1> = 51,
		BridgeWestendParachains: pallet_bridge_parachains::<Instance1> = 52,
		BridgeWestendMessages: pallet_bridge_messages::<Instance1> = 53,
		XcmOverBridgeHubWestend: pallet_xcm_bridge_hub::<Instance1> = 54,
...
mod benches {
	frame_benchmarking::define_benchmarks!(
		...
		[pallet_bridge_parachains, WestendParachains]
		[pallet_bridge_messages, WestendMessages]
		// Ethereum Bridge
...
impl_runtime_apis! {
	...
	impl bp_bridge_hub_westend::BridgeHubWestendFinalityApi<Block> for Runtime {
		fn best_finalized() -> Option<bp_runtime::HeaderId<bp_bridge_hub_westend::Hash, bp_bridge_hub_westend::BlockNumber>> {
	...
	impl frame_benchmarking::Benchmark<Block> for Runtime {
		fn benchmark_metadata(extra: bool) -> (
			...
			type WestendParachains = pallet_bridge_parachains::benchmarking::Pallet::<Runtime, bridge_to_westend_config::BridgeParachainWestendInstance>;
			type WestendMessages = pallet_bridge_messages::benchmarking::Pallet::<Runtime, bridge_to_westend_config::WithBridgeHubWestendMessagesInstance>;
		...
		fn dispatch_benchmark(
			...
			impl pallet_xcm_benchmarks::generic::Config for Runtime {
				...
				fn export_message_origin_and_destination(
					...
					Ok(
						(
							bridge_to_westend_config::FromAssetHubPolkadotToAssetHubWestendRoute::get().location,
							NetworkId::Westend,
			...
			impl BridgeParachainsConfig<bridge_to_westend_config::BridgeParachainWestendInstance> for Runtime {
				...
				fn prepare_parachain_heads_proof(
					...
					prepare_parachain_heads_proof::<Runtime, bridge_to_westend_config::BridgeParachainWestendInstance>(
						parachains,
						parachain_head_size,
						proof_size,
					)
			...
			impl BridgeMessagesConfig<bridge_to_westend_config::WithBridgeHubWestendMessagesInstance> for Runtime {
				...
				fn prepare_message_proof(
					...
					prepare_message_proof_from_parachain::<
						Runtime,
						bridge_to_westend_config::BridgeGrandpaWestendInstance,
