...
use super::{
	...
	bridge_to_westend_config::{
		DeliveryRewardInBalance, RequiredStakeForStakeAndSlash, ToBridgeHubWestendHaulBlobExporter,
	},
		...
		matches!(
			...
			RuntimeCall::PolkadotXcm(
				...
				RuntimeCall::BridgeWestendGrandpa(pallet_bridge_grandpa::Call::<
					Runtime,
					crate::bridge_to_westend_config::BridgeGrandpaWestendInstance,
				>::initialize { .. }) |
				RuntimeCall::BridgeWestendGrandpa(pallet_bridge_grandpa::Call::<
					Runtime,
					crate::bridge_to_westend_config::BridgeGrandpaWestendInstance,
				...
				RuntimeCall::BridgeWestendParachains(pallet_bridge_parachains::Call::<
					Runtime,
					crate::bridge_to_westend_config::BridgeParachainWestendInstance,
				>::set_operating_mode { .. }) |
				RuntimeCall::BridgeWestendMessages(pallet_bridge_messages::Call::<
					Runtime,
					crate::bridge_to_westend_config::WithBridgeHubWestendMessagesInstance,
				>::set_operating_mode { .. }) |
...
impl xcm_executor::Config for XcmConfig {
	...
	type MessageExporter =
		(ToBridgeHubWestendHaulBlobExporter, crate::bridge_to_ethereum_config::SnowbridgeExporter);
